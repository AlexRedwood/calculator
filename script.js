...
function showValues(ping = "") {
  console.table([
    ...
    ["loopThis", loopThis],
    ["secondNumberForLoop", secondNumberForLoop],
...
numberButtons.forEach(btn => {
  btn.addEventListener("click", () => {
    ...
    if (
      ...
      display.textContent.search(/\./g) != -1
    ) {
...
dot.addEventListener("click", () => {
  if (display.textContent.search(/\./g) == -1 && clearField == 0) {
    ...
    (clearField == 1 && log.textContent != "") ||
    (clearField == 1 && secondNumberForLoop != null) ||
    (clearField == 1 && accumulator != null)
  ) {
    display.textContent = "0.";
    clearField = 0;
  }
